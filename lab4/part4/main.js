...
// Update Ball class to inherit from Shape
...
// Define EvilCircle class inheriting from Shape
class EvilCircle extends Shape {
  ...
  draw() {
    ctx.beginPath();
    ctx.strokeStyle = this.color; // Outer stroke
...
const evilCircle = new EvilCircle(width / 2, height / 2); // Starts in center of canvas
